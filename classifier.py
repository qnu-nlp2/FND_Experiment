...
build_confusion_matrix(knn_pipeline_ngram)
#========================================================================================
...
print(classification_report(DataPrep.test_news['Label'], predicted_knn_ngram))
